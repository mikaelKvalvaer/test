...
//-------------------------------------------------------------------------------
//  @fn can_free_single_mob
//!
//! This function clears the Mailbox content of a single mob.
//! It uses Can_clear_mob() macro
//!
//! @warning none.
//!
//! @param uint8_t mob to clear.
//!
//! @return none.
//!
...
//! @return none.
//------------------------------------------------------------------------------
void can_get_data(can_data_t* p_can_message_data)
{
    for (uint8_t i = 0; i < (Can_get_dlc()); i++)
    {
        p_can_message_data->u8[i] = CANMSG;
    }
}
...
void can_configureBitTiming(uint8_t conf1, uint8_t conf2, uint8_t conf3){
	CANBT1 = conf1;
	CANBT2 = conf2;
	CANBT3 = conf3;
}
void can_setBaudrate8MHZ(enum canBaudRate baudrate){
	switch(baudrate){
		case CAN_BPS_1000k:
		//!< -- 1 Mb/s, 8x Tscl, sampling at 75%
		// Tscl  = 1x Tclkio = 125 ns
		// Tsync = 1x Tscl, Tprs = 3x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 2x Tscl, Tpsh2 = 2x Tscl, 3 sample points
		can_configureBitTiming(0x00,0x04,0x13);
		break;
		case CAN_BPS_500K:
		//!< -- 500Kb/s, 8x Tscl, sampling at 75%
		// Tscl  = 2x Tclkio = 250 ns
		// Tsync = 1x Tscl, Tprs = 3x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 2x Tscl, Tpsh2 = 2x Tscl, 3 sample points
		can_configureBitTiming(0x02,0x04,0x13);
		break;
		case CAN_BPS_250K:
		//!< -- 250Kb/s, 16x Tscl, sampling at 75%
		// Tscl  = 2x Tclkio = 250 ns
		// Tsync = 1x Tscl, Tprs = 7x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 4x Tscl, Tpsh2 = 4x Tscl, 3 sample points
		can_configureBitTiming(0x02,0x0C,0x37);
		break;
		case CAN_BPS_200K:
		//!< -- 200Kb/s, 20x Tscl, sampling at 75%
		// Tscl  = 2x Tclkio = 250 ns
		// Tsync = 1x Tscl, Tprs = 8x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 6x Tscl, Tpsh2 = 5x Tscl, 3 sample points
		can_configureBitTiming(0x02,0x0E,0x4B);
		break;
		case CAN_BPS_125K:
		//!< -- 125Kb/s, 16x Tscl, sampling at 75%
		// Tscl  = 4x Tclkio = 500 ns
		// Tsync = 1x Tscl, Tprs = 7x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 4x Tscl, Tpsh2 = 4x Tscl, 3 sample points
		can_configureBitTiming(0x06,0x0C,0x37);
		break;
		case CAN_BPS_100K:
		//!< -- 100Kb/s, 16x Tscl, sampling at 75%
		// Tscl  = 5x Tclkio = 625 ns
		// Tsync = 1x Tscl, Tprs = 7x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 4x Tscl, Tpsh2 = 4x Tscl, 3 sample points
...
void can_setBaudrate12MHZ(enum canBaudRate baudrate){
	switch(baudrate){
		case CAN_BPS_1000k:
		//!< -- 1 Mb/s, 12x Tscl, sampling at 75%
		// Tscl  = 1x Tclkio = 83.333 ns
		// Tsync = 1x Tscl, Tprs = 5x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 3x Tscl, Tpsh2 = 3x Tscl, 3 sample points
		can_configureBitTiming(0x00,0x08,0x25);
		break;
		case CAN_BPS_500K:
		//!< -- 500Kb/s, 12x Tscl, sampling at 75%
		// Tscl  = 2x Tclkio = 166.666 ns
		// Tsync = 1x Tscl, Tprs = 5x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 3x Tscl, Tpsh2 = 3x Tscl, 3 sample points
		can_configureBitTiming(0x02,0x08,0x25);
		break;
		case CAN_BPS_250K:
		//!< -- 250Kb/s, 16x Tscl, sampling at 75%
		// Tscl  = 3x Tclkio = 250 ns
		// Tsync = 1x Tscl, Tprs = 7x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 4x Tscl, Tpsh2 = 4x Tscl, 3 sample points
		can_configureBitTiming(0x04,0x0C,0x37);
		break;
		case CAN_BPS_200K:
		//!< -- 200Kb/s, 20x Tscl, sampling at 75%
		// Tscl  = 3x Tclkio = 250 ns
		// Tsync = 1x Tscl, Tprs = 8x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 6x Tscl, Tpsh2 = 5x Tscl, 3 sample points
		can_configureBitTiming(0x04,0x0E,0x4B);
		break;
		case CAN_BPS_125K:
		//!< -- 125Kb/s, 16x Tscl, sampling at 75%
		// Tscl  = 6x Tclkio = 500 ns
		// Tsync = 1x Tscl, Tprs = 7x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 4x Tscl, Tpsh2 = 4x Tscl, 3 sample points
		can_configureBitTiming(0x0A,0x0C,0x37);
		break;
		case CAN_BPS_100K:
		//!< -- 100Kb/s, 20x Tscl, sampling at 75%
		// Tscl  = 6x Tclkio = 500 ns
		// Tsync = 1x Tscl, Tprs = 8x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 6x Tscl, Tpsh2 = 5x Tscl, 3 sample points
...
void can_setBaudrate16MHZ(enum canBaudRate baudrate){
	switch(baudrate){
		case CAN_BPS_1000k:
		//!< -- 1 Mb/s, 8x Tscl, sampling at 75%
		// Tscl  = 2x Tclkio = 125 ns
		// Tsync = 1x Tscl, Tprs = 3x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 2x Tscl, Tpsh2 = 2x Tscl, 3 sample points
		can_configureBitTiming(0x02,0x04,0x13);
		break;
		case CAN_BPS_500K:
		//!< -- 500Kb/s, 8x Tscl, sampling at 75%
		// Tscl = 4x Tclkio = 250 ns
		// Tsync = 1x Tscl, Tprs = 3x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 2x Tscl, Tpsh2 = 2x Tscl, 3 sample points
		can_configureBitTiming(0x06,0x04,0x13);
		break;
		case CAN_BPS_250K:
		//!< -- 250Kb/s, 16x Tscl, sampling at 75%
		// Tscl  = 4x Tclkio = 250 ns
		...
		break;
		case CAN_BPS_200K:
		//!< -- 200Kb/s, 16x Tscl, sampling at 75%
		// Tscl  = 5x Tclkio = 312.5 ns
		// Tsync = 1x Tscl, Tprs = 7x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 4x Tscl, Tpsh2 = 4x Tscl, 3 sample points
		can_configureBitTiming(0x08,0x0C,0x37);
		break;
		case CAN_BPS_125K:
		//!< -- 125Kb/s, 16x Tscl, sampling at 75%
		// Tscl  = 8x Tclkio = 500 ns
		// Tsync = 1x Tscl, Tprs = 7x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 4x Tscl, Tpsh2 = 4x Tscl, 3 sample points
		can_configureBitTiming(0x0E,0x0C,0x37);
		break;
		case CAN_BPS_100K:
		//!< -- 100Kb/s, 16x Tscl, sampling at 75%
		// Tscl  = 10x Tclkio = 625 ns
		// Tsync = 1x Tscl, Tprs = 7x Tscl, Tsjw = 1x Tscl
		// Tpsh1 = 4x Tscl, Tpsh2 = 4x Tscl, 3 sample points
...
void can_setBaudrate(enum can_peripheral_clock clock, enum canBaudRate baudrate){
	switch(clock){
	case clkph_8MHZ:
...
void can_init(enum can_peripheral_clock clock, enum canBaudRate baudrate){
	Can_reset();
