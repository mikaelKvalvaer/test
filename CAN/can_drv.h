...
enum can_peripheral_clock{clkph_8MHZ,clkph_12MHZ, clkph_16MHZ };
enum canBaudRate{CAN_BPS_1000k, CAN_BPS_500K, CAN_BPS_250K, CAN_BPS_200K, CAN_BPS_125K, CAN_BPS_100K, AUTO_BAUD};
    // ----------
...
//! @return none.
//!
extern  void can_get_data(can_data_t* p_can_message_data);
