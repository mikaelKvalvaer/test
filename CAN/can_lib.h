...
// ----------
// Definition of mask variable, for reception of masked messages
extern uint32_t CANLIB_DATA_MESSAGE_RX_MASK;
...
extern void can_init(enum can_peripheral_clock clock, enum canBaudRate baudrate);
//--e----------------------------------------------------------------------------
//  @fn can_cmd
//!
